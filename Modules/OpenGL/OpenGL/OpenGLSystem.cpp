...
void loadAndCompileShadersSync(ECS::Registry& registry, World& world)
{
    ...
    const EntityId collectionId = Resources::loadSync<ShaderCollection>(registry, collectionPath);
...
void OpenGLSystem::onInitialize(ECS::Registry& registry, World& world)
{
    ...
    const EntityId openglConfigId = Resources::loadSync<OpenGLConfig>(registry, Mani::FileSystem::getConfigFilePath());
