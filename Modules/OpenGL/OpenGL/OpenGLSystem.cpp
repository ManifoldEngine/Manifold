...
void loadAndCompileShadersSync(ECS::Registry& registry, World& world)
{
    ...
    const fs::path collectionPath = FileSystem::getRootPath().append(Mani::SHADERCOLLECTION_FILENAME);
...
void OpenGLSystem::onInitialize(ECS::Registry& registry, World& world)
{
    ...
    Ref<Resource<OpenGLConfig>> config = registry.get<Resource<OpenGLConfig>>(openglConfigId);
