...
MANI_SECTION_BEGIN(Core_World, "Core World")
{
	...
	MANI_TEST(ShouldBeAbleToMixupSystemCreationAccrossMultipleTickGroups, "Should Be Able To Mixup System Creation Accross Multiple TickGroups")
	{
		...
		class SomePreUpdateSystem :		public ECS::System { public: virtual ETickGroup getTickGroup() const override { return ETickGroup::PreUpdate;	} virtual std::string_view getName() const override { return "SomePreUpdateSystem";	}	virtual void tick(ECS::Registry& registry) override { registry.getSingle<TickOrder>()->order.push_back(getName().data()); } virtual bool shouldTick(ECS::Registry& registry) const override { return true; }};
		class SomeUpdateSystem :		public ECS::System { public: virtual ETickGroup getTickGroup() const override { return ETickGroup::Update;		} virtual std::string_view getName() const override { return "SomeUpdateSystem";	}	virtual void tick(ECS::Registry& registry) override { registry.getSingle<TickOrder>()->order.push_back(getName().data()); } virtual bool shouldTick(ECS::Registry& registry) const override { return true; }};
		class SomePostUpdateSystem :	public ECS::System { public: virtual ETickGroup getTickGroup() const override { return ETickGroup::PostUpdate;	} virtual std::string_view getName() const override { return "SomePostUpdateSystem";}	virtual void tick(ECS::Registry& registry) override { registry.getSingle<TickOrder>()->order.push_back(getName().data()); } virtual bool shouldTick(ECS::Registry& registry) const override { return true; }};
		class SomePreRenderSystem :		public ECS::System { public: virtual ETickGroup getTickGroup() const override { return ETickGroup::PreRender;	} virtual std::string_view getName() const override { return "SomePreRenderSystem";	}	virtual void tick(ECS::Registry& registry) override { registry.getSingle<TickOrder>()->order.push_back(getName().data()); } virtual bool shouldTick(ECS::Registry& registry) const override { return true; }};
		class SomeRenderSystem :		public ECS::System { public: virtual ETickGroup getTickGroup() const override { return ETickGroup::Render;		} virtual std::string_view getName() const override { return "SomeRenderSystem";	}	virtual void tick(ECS::Registry& registry) override { registry.getSingle<TickOrder>()->order.push_back(getName().data()); } virtual bool shouldTick(ECS::Registry& registry) const override { return true; }};
		class SomePostRenderSystem :	public ECS::System { public: virtual ETickGroup getTickGroup() const override { return ETickGroup::PostRender; }  virtual std::string_view getName() const override { return "SomePostRenderSystem";}	virtual void tick(ECS::Registry& registry) override { registry.getSingle<TickOrder>()->order.push_back(getName().data()); } virtual bool shouldTick(ECS::Registry& registry) const override { return true; }};
